...
<div className="block relative  w-64  "> 
    ...
    <input type="text" onChange={handleEdit} id="name" className="w-full h-8 bg-transparent placeholder-black border-b-2 border-gray-300 pl-8 py-1 text-sm focus:outline-none focus:border-indigo-400"
 />    
    </div>
<div className="block relative w-64 "> 
    <label htmlFor="email" className="block text-gray-600 cursor-text text-sm leading-[140%] font-normal mb-2">Email</label>
    <input type="text" onChange={handleEdit} id="email" className="w-full h-8 bg-transparent placeholder-black border-b-2 border-gray-300 pl-8 py-1 text-sm focus:outline-none focus:border-indigo-400"
 />
    
    </div>
    <div className="block relative  w-64 "> 
    <label htmlFor="password" className="block text-gray-600 cursor-text text-sm leading-[140%] font-normal mb-2">Password</label>
    <input type="text" onChange={handleEdit} id="password"  className="w-full placeholder-black h-8 bg-transparent  border-b-2 border-gray-300 pl-8 py-1 text-sm focus:outline-none focus:border-indigo-400"
/>
    
    </div>   <input type="submit" className="bg-indigo-500 w-max m-auto px-6 py-2 rounded text-white text-sm font-normal" />
          <div className='flex gap-2'>
        <p className="text-1xl text-indigo-800 z-10">have an account ?</p>
        <Link to={'/login'} className="text-1xl text-indigo-800 z-10">Login</Link>
</div>
           </form>
